...
- Estudo da linguagem C, um código bem simples que abrange variáveis, estrutura condicionais.

- Skills da linguagem: estrutura condicionais(if e else) printf, scanf e variável float.
